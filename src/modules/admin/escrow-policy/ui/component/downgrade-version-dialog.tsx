...
import { useDowngradeEscrowPolicyVersionMutation } from "@/gql/client-mutation-options/escrow-policies-mutation";
import {
...
interface DowngradeVersionDialogProps {
  ...
  onSuccess?: () => void;
  availablePolicies: EscrowCommissionPolicy[];
}
...
export function DowngradeVersionDialog({
  ...
  const downgradeMutation = useDowngradeEscrowPolicyVersionMutation();
