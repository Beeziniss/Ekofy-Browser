...
import { useSwitchEscrowToLatestVersionMutation } from "@/gql/client-mutation-options/escrow-policies-mutation";
...
export function SwitchToLatestDialog({
  ...
  const switchMutation = useSwitchEscrowToLatestVersionMutation();
