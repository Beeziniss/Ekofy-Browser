          ...
          <div className="space-y-6 text-gray-300">
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                services. This platform is developed as a Capstone Project at FPT University. By checking the &quot;I
                Agree&quot; box or using the service, you acknowledge that you have read, understood, and agreed to
                these terms.
              </p>
            </section>
              ...
              <div className="ml-4 space-y-3">
                ...
                <div>
                  ...
                  <ul className="ml-6 list-disc space-y-1">
                    ...
                    <li>
                      <strong className="text-white">Payout Cycle:</strong> Royalties are processed and paid out on a
                      T+60 or T+90 day cycle (60 to 90 days after the end of the month in which revenue is earned).
                    </li>
                    <li>
                      <strong className="text-white">Minimum Payout Threshold:</strong> You may only withdraw funds
                      once your balance reaches the minimum threshold (e.g., $20).
                    </li>
                    <li>
            ...
            <section className="space-y-3">
              ...
              <ul className="ml-6 list-disc space-y-2">
                ...
                <li>
                  <strong className="text-white">Limitation of Liability:</strong> Ekofy provides the service &quot;as
                  is&quot; and assumes no liability for any data loss, service interruptions, or unauthorized access to
                  your account.
                </li>
              </ul>
            </section>
