...
const AuthenticatedPlaylistSection = () => {
  return (
    <Suspense fallback={<AuthenticatedPlaylistSectionSkeleton />}>
      <AuthenticatedPlaylistSectionSuspense />
    </Suspense>
  );
};

const AuthenticatedPlaylistSectionSkeleton = () => {
  return (
...
const AuthenticatedPlaylistSectionSuspense = () => {
...
export default AuthenticatedPlaylistSection;
