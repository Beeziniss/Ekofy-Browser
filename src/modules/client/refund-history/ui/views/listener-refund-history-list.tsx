...
import { RefundListSection } from "../sections/refund-list-section";

export function ListenerRefundHistoryList() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-6 md:px-6">
      ...
      <p className="text-muted-foreground mb-6 text-sm">All refund transactions for your payments on Ekofy.</p>
      <RefundListSection />
    </div>
  );
}
