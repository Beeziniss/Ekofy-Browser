...
export type DeActiveUserMutation = { __typename?: 'MutationInitialization', deActiveUser: boolean };
...
export const DeActiveUserDocument = new TypedDocumentString(`
    mutation DeActiveUser($targetUserId: String!) {
  deActiveUser(targetUserId: $targetUserId)
}
    `) as unknown as TypedDocumentString<DeActiveUserMutation, DeActiveUserMutationVariables>;
